...
export const Card = ({
  ...
  return (
    <motion.button
      ...
      className="relative z-10 flex h-64 w-60 flex-col items-start justify-end overflow-hidden rounded-3xl bg-gray-100 md:h-[28rem] md:w-[23rem] lg:h-[34rem] lg:w-[28rem] dark:bg-neutral-900"
    >
