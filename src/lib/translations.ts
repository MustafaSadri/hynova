  ...
  ru: {
    ...
    about: {
      ...
      stats: [
        ...
        { value: "3+", label: "Наличие премиальных продуктов" },
    ...
    portfolio: {
      ...
      subtitle: "Инвационная терапия метаболического здоровья, разработанная для максимальной эффективности, безопасности и удобства пациентов.",
      viewSpecs: "Характеристики",
      backToOverview: "Назад",
      specsLabel: "Характеристики",
      products: [
        {
          name: "Ретатрутид (Инъекции)",
          ...
          specs: [
            ...
            "Наивысшая эффективность жиросжигания",
            "GMP-сертифицирован, чистота каждой партии ≥ 99,9%",
          ],
        },
        {
          name: "Ретатрутид (Порошок)",
          ...
          specs: [
            ...
            "Подтверждённая чистота ≥ 99,9%",
            "Сублимационная сушка для максимальной стабильности и срока хранения",
            "Без добавок, стабилизаторов и наполнителей",
          ],
        },
        {
          name: "Тирзепатид (Инъекции)",
          category: "Двойной агонист рецепторов · Инъекционный",
          description: "Тирзепатид (Tirzepatide) — золотой стандарт терапии двойным агонистом для контроля метаболизма.",
          specs: [
        ...
        },
        {
          ...
          specs: [
            ...
            "Доступные дозировки: 2,5; 5; 7,5; 10; 12,5; 15 мг",
            "Форма: Лиофилизированный порошок — разводится перед использованием",
            "Гарантированная чистота ≥ 99,9%",
            "Сублимационная сушка для максимальной стабильности и срока хранения",
            "Идеален для клинических лабораторий с точными требованиями к концентрации",
          ],
        },
        {
          name: "Орфорглипрон (Таблетки)",
          category: "Пероральный агонист GLP-1 · Непептид",
          description: "Орфорглипрон (Orforglipron) — инновационная пероральная непептидная терапия для удобства пациентов.",
          specs: [
            "Механизм: Пероральный агонист рецепторов GLP-1 (непептид)",
            "Доступные дозировки: 0,8 мг; 2,5 мг; 5,5 мг; 9 мг; 14,5 мг; 17,2 мг",
            ...
            "Стимулирует рецепторы GLP-1 для регуляции аппетита",
    ...
    // ── Innovation / Manufacturing Excellence ───────────────────────────────────
    innovation: {
      sectionLabel: "Передовые производственные стандарты",
      title: "Основано на высокой точности",
      titleHighlight: "Доставляется в полной сохранности",
      steps: [
        {
          title: "GMP-производство",
          desc: "передовые производственные мощности с полной сертификацией.",
        },
        {
          title: "Соблюдение температурного режима",
          desc: "логистика с контролем температуры.",
        },
        {
          title: "Контроль качества",
          desc: "многоступенчатое тестирование и соответствие международным стандартам.",
        },
        {
          title: "Масштабируемое производство",
          desc: "позволяет удовлетворять глобально растущий спрос.",
        },
      ],
    },
    ...
    globalFootprint: {
      ...
      phases: [
        {
          phase: "Этап 1",
          status: "В текущий момент",
          title: "Ближний Восток, Россия и СНГ",
          description: "Укрепление присутствия в ОАЭ и расширение премиальной метаболической терапии на Ближнем Востоке, в России и странах СНГ.",
          regions: ["Объединённые Арабские Эмираты", "Саудовская Аравия", "Россия", "Казахстан", "Азербайджан"],
        },
        {
          phase: "Этап 2",
          status: "В ближайшее время",
          title: "Выход на европейский и азиатский рынки",
          description: "Стратегический выход на европейские и азиатские рынки в партнёрстве с ведущими медицинскими дистрибьюторами и клиническими сетями.",
    ...
    visionMission: {
      ...
      visionText: "Стать одним из самых надежных инноваторов в области метаболического здоровья в мире, задавая стандарты эффективности и безопасности.",
      missionTitle: "Наша миссия",
      missionItems: [
        { title: "Научные инновации", desc: "Расширение границ метаболической медицины с помощью передовых исследований." },
        { title: "Высокое качество продукции", desc: "Строгий контроль качества и GMP-сертифицированное производство." },
        { title: "Производственное совершенство на глобальном уровне", desc: "Передовые комплексы, спроектированные для масштабирования и поддержания температурной цепочки." },
        { title: "Пациентоориентированный подход", desc: "Предоставление терапии, оптимизированной для удобства пациентов и премиального опыта лечения." }
      ]
    },
    therapeuticFocus: {
      ...
      items: [
        ...
        { title: "Контроль веса", desc: "Точечное терапевтическое вмешательство для долгосрочной регуляции массы тела." },
      ...
      rows: [
        {
          ...
          profile: "Случаи с низкой эффективностью предшествующего лечения"
        },
        {
          name: "Тирзепатид",
          mechanism: "Двойной агонист (GLP1/GIP)",
          administration: "Еженедельная инъекция",
          target: "Контроль ожирения и диабета 2 типа",
        ...
        },
        {
          ...
          target: "Удобное управление весом",
          profile: "Пациенты, предпочитающие пероральную терапию"
        }
      ]
    },
    roadmap: {
      title: "Продуктовый портфель и план развития",
      subtitle: "Наша план развития подразумевает переход от флагманских метаболических терапий к разработкам в кардиологии.",
      steps: [
        { num: "01", name: "Ретатрутид", status: "Текущий флагман", desc: "Тройной агонист рецепторов, активно лидирующий в результатах регуляции веса." },
        { num: "02", name: "Тирзепатид", status: "В стадии внедрения", desc: "Двойной агонист GLP-1/GIP с обширной клинической валидацией и дистрибуцией." },
        { num: "03", name: "Орфорглипрон", status: "2026 год", desc: "Пероральная таблетка для ежедневного приема, освобождающая от уколов при лечении ожирения." },
        { num: "04", name: "Кардиопортфель", status: "Разработка", desc: "Масштабирование лечебного воздействия в области здоровья сердечно-сосудистой системы и липидов." }
      ]
    },
  },
} as const;
