...
const translations = {
  ...
  ru: {
    ...
    about: {
      ...
      p2: "Опираясь на швейцарский опыт и американские технологии, мы разрабатываем решения следующего поколения, сочетающие научный подход с высоким уровнем комфорта и удобства для пациента. Наша цель — переопределить мировые стандарты в лечении ожирения с помощью передовых пептидных и пероральных технологий.",
      stats: [
    ...
    roadmap: {
      ...
      steps: [
        ...
        { num: "04", name: "Кардиопортфель", status: "Разработка", desc: "Расширение терапевтического охвата в области здоровья сердечно-сосудистой системы и липидов." }
      ]
    },
  },
} as const;
